...
with_node \
  ...
  --target "/Users/user/Documents/Study/hubble-Networking/ios/Pods/Target Support Files/Pods-NubbleApp-NubbleAppTests/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-constants" "expo-file-system" "expo-image-manipulator" "expo-keep-awake"
